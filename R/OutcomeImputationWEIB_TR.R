...
UNEQUALCENSIMPUTEWEIB_TR = function(datWIDE, beta, alpha, scale, shape, ImputeDat, TransCov){
	...
	#data.frame(datWIDE$Y_R[INDICES], datWIDE$Y_D[INDICES], YRImp[INDICES] )
