...
#'}
#' @details This function cannot be applied when 'T_R' is included in the model for Recurrence -> Death. In this case, use the function UNEQUALCENSIMPUTEWEIBINVERSION.
#' @export
